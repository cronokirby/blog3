...
const Content = () => (
  <div className="flex flex-col items-center w-full mt-12 md:mt-24">
    <div className="relative inline-block">
      ...
      <h1 className="relative z-10 text-4xl font-bold text-main sm:text-5xl md:text-8xl">
        Lúcás Meier
      </h1>
      <h2 className="relative z-10 text-2xl text-main sm:text-3xl md:text-6xl">
        Fullstack Developer
      </h2>
    </div>
    <div className="flex flex-wrap items-center justify-center mt-16 md:mt-32">
      ...
      <div className="relative inline-block h-64 mx-8">
        ...
        <div className="relative z-10 flex flex-wrap items-center justify-center py-4">
          <div className="relative z-10 mx-4 text-main">
            <h1 className="text-2xl font-bold text-main sm:text-3xl md:text-4xl">
              I make websites
            </h1>
            <p className="text-sm">
              But not{' '}
